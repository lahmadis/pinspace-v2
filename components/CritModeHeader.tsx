...
export default function CritModeHeader({
  ...
  return (
    <motion.header
      ...
      animate={{ y: 0 }}
      role="status"
      className="fixed inset-x-0 top-0 z-50 max-h-[45dvh] overflow-y-auto border-b border-red-800 bg-red-800/95 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] text-white shadow-[var(--shadow-raised)] backdrop-blur-md motion-reduce:transition-none"
    >
