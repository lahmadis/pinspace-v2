...
export default function WorkspaceNetworkPage() {
  return <Suspense fallback={<main className="flex min-h-screen items-center justify-center bg-kova-forest px-4"><StatusState status="loading" title="Loading workspace network" /></main>}><WorkspaceNetworkInner /></Suspense>
}
