...
/** GET /api/network/personal/[workspaceId] — returns a workspace and its rooms.
 *  Returns 404 if the workspace doesn't exist or doesn't belong to the caller.
 */
export async function GET(
  ...
  try {
    ...
    if (roomsErr) {
      console.error('network/personal/[workspaceId] GET rooms error:', roomsErr)
    ...
    console.error('network/personal/[workspaceId] GET error:', err)
